                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 5,),
                            Text("Louis vuitton",style:TextStyle(fontSize: 16,fontFamily: "Montserrat",color: Colors.grey),),
                            SizedBox(height: 10,),
                            Container(
                              height: 30,
                                width: MediaQuery.of(context).size.width-165,
                                child: Text("One button V-neck sling long-sleved waist female stitching dress",style:TextStyle(fontSize: 14,fontFamily: "Montserrat",color: Colors.grey),)),
                          ],
                        )
                      ],
                    ),
